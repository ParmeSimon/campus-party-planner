...
export const EventProvider = ({ children }) => {
    ...
    return (
        <EventContext.Provider value={{ isDarkMode, toggleDarkMode, events, cities, selectedCity, likedEvents, setSelectedCity, setLikedEvents, setEvents, toggleLike, categories, stats }}>
            {children}
